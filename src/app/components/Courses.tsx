            ...
            <div key={index} className={styles.course__card}>
              <div className={styles.image__div}>
                ...
                <div className={styles.hover__icon}>
                  <FiShoppingCart  className={styles.top__icon} />
                  <FaRegHeart className={styles.top__icon} />
                </div>
              </div>
              <div className={styles.course__link}>
                <a href="#" className={styles.course__link1}>
                  {item.link1}
                </a>
                <a href="#" className={styles.course__link2}>
                  {item.link2}
                </a>
              </div>
              <h3>{item.heading}</h3>
              ...
              <div className={styles.course__details}>
                <div className={styles.course__details__inner}>
                  <MdTimer size={24} color="#9998E1" />
                  <span>{item.time}</span>
                </div>
                <span className={styles.course__details__line}>|</span>
                <div className={styles.course__details__inner}>
                  <FaBookOpen size={24} color="#9998E1" />
                  <span>{item.lession}</span>
                </div>
              </div>
